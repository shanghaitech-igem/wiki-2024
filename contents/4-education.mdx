...
<Tabs>
  <Tab title="Pipette">
    ...
    ![Demonstration of pipette in the module](server/contents/edu/mc/mod-design-1.png)
...
Our mod is available in both English and Chinese. Click [here](https://gitlab.igem.org/zivmax/mcreator-page-archive/-/raw/main/downloads/igem-shanghaitech-synthetic-bio-forge-1.20.1.jar) to download.

The mod is compatible with Minecraft Java Edition 1.20.1 Fabric version. Please use this version to install the mod.

If you want to know more about this module, please check the tutorial below.

<PDF src="server/contents/edu/mc/Module-tutorial.pdf" />
