...
![The method of operations from gene to music](server/contents/edu/melody/platform.webp)
...
![An example of scale](server/contents/edu/melody/tone-1.webp)

![An example of scale](server/contents/edu/melody/tone-2.webp)
...
<Tabs>
  <Tab title="Pipette">
    ...
    ![Demonstration of pipette in the mod](server/contents/edu/mc/mod-design-1.webp)
  ...
  <Tab title="Mcoli">
    ![Demonstration of Mcoli](server/contents/edu/mc/mod-design-2.webp)
  ...
  <Tab title="Genes">
    ![Demonstration of Minecraft-specific genes](server/contents/edu/mc/mod-design-3.webp)
  ...
  <Tab title="Devices">
    ![Demonstration of Bio-Workbench](server/contents/edu/mc/mod-design-4.webp)

    ![Demonstration of Sequencing Analyzer and PCR Machine](server/contents/edu/mc/mod-design-5.webp)
  ...
  <Tab title="PCR">
    ![Demonstration of Taq Polymerase and GFP Protein](server/contents/edu/mc/mod-design-6.webp)
...
<Gallery
  srcList={[
    "server/contents/edu/card/card1-1.webp",
    "server/contents/edu/card/card1-2.webp",
    "server/contents/edu/card/card1-3.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/card/card2-1.webp",
    "server/contents/edu/card/card2-2.webp",
    "server/contents/edu/card/card2-3.webp",
  ]}
/>
...
![The number of views and comments on the video has reached a high level](server/contents/edu/pop/media-1.webp)
...
![Huang Zhejing and Gao Shenyuan's popular science activity at Jianping Experimental School](server/contents/edu/teach/teach-1.webp)
...
<Gallery
  srcList={[
    "server/contents/edu/teach/teach-2.webp",
    "server/contents/edu/teach/teach-3.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/teach/teach-4.webp",
    "server/contents/edu/teach/teach-5.webp",
    "server/contents/edu/teach/teach-6.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/teach/teach-7.webp",
    "server/contents/edu/teach/teach-8.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/teach/teach-9.webp",
    "server/contents/edu/teach/teach-10.webp",
  ]}
/>
...
![Tian Di's popular science activity at Jingxian County Middle School](server/contents/edu/teach/teach-11.webp)
...
<Gallery
  srcList={[
    "server/contents/edu/publicity/pub-1.webp",
    "server/contents/edu/publicity/pub-2.webp",
    "server/contents/edu/publicity/pub-3.webp",
    "server/contents/edu/publicity/pub-4.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/publicity/pub-5.webp",
    "server/contents/edu/publicity/pub-6.webp",
  ]}
/>
...
<Gallery
  srcList={[
    "server/contents/edu/publicity/pub-7.webp",
    "server/contents/edu/publicity/pub-8.webp",
  ]}
/>
