...
![The mechanism by which human skin experiences itching upon exposure to Staphylococcus aureus.](server/contents/pj/human.png)
...
![Detecting the efficacy of substances in a fluorescent reporter system simulating human itch sensation in Escherichia coli](server/contents/pj/ecoli.png)
