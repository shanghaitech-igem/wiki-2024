...
![Design Sketch](server/contents/hardware/zoom-in.jpg)
## Product Advantage
...
![PCB Top](server/contents/hardware/pcb-top.png)
![PCB Bottom](server/contents/hardware/pcb-bottom.png)
...
![Scratcher Head](server/contents/hardware/scratcher-head.jpg)
![Motor](server/contents/hardware/motor.jpg)
## Electric Scratcher
