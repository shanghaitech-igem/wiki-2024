...
![Exploded View](server/contents/hardware/sec-1-virtual-1.jpg)
![Exploded View](server/contents/hardware/sec-1-virtual-2.jpg)
...
<Model title="The Three Parts" src="server/contents/hardware/pa3-1.stl" />

<Model title="Scratcher Head" src="server/contents/hardware/balls.stl" />
...
<Model title="Container" src="server/contents/hardware/upper.stl" />
...
<Model title="3D Design Sketch" src="server/contents/hardware/upper.stl" />
