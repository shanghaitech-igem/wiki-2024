...
![Q column](server/contents/pj/q.jpg)
...
![Drug Screening in the Lab](server/contents/pj/screen-fluoro.jpg)
...
![Plasmids for the FlipGFP system](server/contents/plasmid/flipgfp.jpg)
...
- Build
  ...
  ![Plasmid for FlipGFP(V8)](server/contents/plasmid/gfp-v8.png)
...
- Build
  ...
  ![Plasmid for FlipGFP(V8)](server/contents/plasmid/gfp-v8s.png)
...
![The mechanism by which human skin experiences itching upon exposure to Staphylococcus aureus.](server/contents/pj/human.jpg)
...
![The 3D structure of gseA(Glutamyl endopeptidase)](server/contents/wetlab/gsea.jpg)[^5]

[^5]: By Jawahar Swaminathan and MSD staff at the European Bioinformatics Institute - https://www.ebi.ac.uk/pdbe/static/entry/1qy6_deposited_chain_front_image-800x800.png, displayed on https://www.ebi.ac.uk/pdbe/entry/pdb/1qy6, Public Domain, https://commons.wikimedia.org/w/index.php?curid=6012163
...
- Test
  ...
  ![Fluorescence Result of Experimental Group](server/contents/wetlab/result/fl/fl-exp-1.png)

  ![Fluorescence Result of Control Group](server/contents/wetlab/result/fl/fl-c-1.png)
