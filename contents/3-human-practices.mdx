...
<Profile
  portrait="server/contents/hp/tangzongxiang.png"
  name="Tang Zongxiang"
  role="Scientists"
  ...
  Contents:
  - Staphylococcus aureus infections are very common in daily life, and wet areas are prone to infection and itching. In addition to Staphylococcus aureus, other factors can also cause itching, and it is recommended to take them into consideration.
  - It is common for patients to seek medical treatment for persistent itching, and short-term mild itching is often ignored.
  - Traditional Chinese medicine has multiple targets and channels, which can enhance its efficacy and is suitable for pruritus caused by multiple factors.
  - From the perspective of biological evolution, pathological pruritus needs to be suppressed. The form of the product should be selected according to the mechanism and severity of the disease, skin care products for mild symptoms, drugs for severe symptoms.
  "
/>
...
<Profile
  ...
  Contents:
  The Labcat is the manager of the lab, and he is responsible for the daily management of the lab."
/>
...
<Profile
  ...
  Contents:
  After our discussion with Professor Yang, we have developed the following ideas: To achieve the goal of itch relief while integrating traditional Chinese medicine (TCM), we can begin by exploring plant-derived small molecules. By combining existing research, we can collect commonly used Chinese herbs and conduct network pharmacological analysis. This can be followed by further animal experiments to observe therapeutic effects and identify effective drugs or small molecule components. This approach will lay a solid foundation for clinical application. Alternatively, we can screen drugs directly using your team's systematic approach."
/>
...
<Profile
  ...
  Contents:
 Scratching caused by itching can lead to additional problems, and Staphylococcus aureus not only induces itching but can also cause infections. Therefore, we aim to develop skincare products with anti-itch properties to prevent further harm to patients.

Professor Yang suggests:

- Consider using theatrical makeup or incorporating the product into sun protection.
- Carefully define the focus of the project. We can concentrate on specific environments or specialized fields and conduct competitive analysis to uncover deeper and more innovative insights.
- When screening natural extracts, explore Chinese herbs and integrate elements of Chinese traditional culture."
/>
...
<Profile
  ...
  brief="Personal Profile: Member of the Dermatology Branch of the China Association of Chinese Medicine
  Contents:
  Dr. Yang Fan informed us that itching is a common clinical symptom, the root cause of repetitive scratching behavior, and a significant factor leading to skin surface damage, exacerbation of chronic inflammation, and disruption of the skin barrier. Currently, there is a lack of objective diagnostic methods. Dr. Yang believes that our E. coli-based itching detection platform is clinically needed and has strong practical significance.

The suggestions we received are:

- Expand the range of detectable itching conditions.
- Collect and screen commonly used Chinese herbal components.
- Explore the integration of traditional Chinese and Western medicine for treatment."
/>
...
<Profile
  ...
  name="Liu Pengxin"
  role="Industry Leader"
  brief="Personal Profile: Assistant Professor, Researcher, and PhD Supervisor at the School of Physical Science and Technology, ShanghaiTech University, and ![a blogger with over one million followers](https://www.weibo.com/u/1954050941).
  Contents:
 Professor Liu Pengxin suggested that when promoting our product to the public, we should emphasize its scientific basis and effectiveness, ensuring the accuracy and reliability of the information to gain consumer trust. He also recommended highlighting why we choose to inhibit bacteria rather than kill them: bacteria are part of the human ecosystem, and by reducing their negative impact on our health, we can prevent more serious diseases. In terms of marketing, he reminded us to avoid making absolute statements or value judgments, and instead base our descriptions on existing scientific evidence, objectively presenting the observed phenomena."
 />
...
{/* 缺名片 */}
<Profile
  portrait="server/contents/hp/20241001-195303.jpg"
  name="Hao Chunqing"
