...
After that, the core dependencies to run the project are all set.
...
### For WSL
If you are using WSL, you should install VSCode in Windows first, then install the `WSL` extension.
